...
Route::middleware('web')->group(function () {
    ...
    Route::get('/blog/the-wrong-technology-for-the-wrong-purpose', [BlogController::class, 'blog10'])->name('blog.blog-10');
    Route::get('/blog/do-people-still-care-about-security', [BlogController::class, 'blog11'])->name('blog.blog-11');
