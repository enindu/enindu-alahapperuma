@php
    ...
    $description = 'I welcome to clients, developers, and all seeking genuine connections and admire spam-free communication through direct email. Your privacy is my priority.';
...
<x-layouts.base :description="$description" :id="$id" :keywords="$keywords" :title="$title" :type="$type">
    <div class="card mt-3">
        <div class="card-body">
            <h1 class="card-title mb-0" id="need-to-get-in-touch-with-me">{{ $title }}</h1>
        </div>
    </div>
    <div class="card mt-3">
        <div class="card-body">
            ...
            <h2 id="avoid-spams">Avoid spams</h2>
            ...
            <h2 id="avoid-spams-again">Avoid spams, again</h2>
            ...
            <h2 id="protect-privacy">Protect privacy</h2>
            ...
            <h2 id="communicate-transparently">Communicate transparently</h2>
