        ...
        <div class="card-body">
            <div class="d-flex flex-column gap-3">
                <div class="d-flex flex-column gap-3">
                    ...
                    <div>
                        <a class="btn btn-primary rounded-pill px-5 py-2" href="{{ route('services.service-1') }}">View Service</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="d-flex flex-column gap-3">
                <div class="d-flex flex-column gap-3">
                    ...
                    <div>
                        <a class="btn btn-primary rounded-pill px-5 py-2" href="{{ route('services.service-2') }}">View Service</a>
                    </div>
                </div>
            </div>
        </div>
