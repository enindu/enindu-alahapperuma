...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="x-content">
                <h1>Running Shell Commands Within Shared Hosting</h1>
