...
<x-layouts.base :description="$description" :id="$id" :keywords="$keywords" :title="$title" :type="$type">
    <x-slot:meta>
        ...
        <meta content="{{ \Carbon\Carbon::parse('2024-01-12 at 05:16 AM')->toIso8601String() }}" property="article:modified_time">
        <meta content="{{ \Carbon\Carbon::parse('2024-01-12 at 05:16 AM')->add('1 year')->toIso8601String() }}" property="article:expiration_time">
