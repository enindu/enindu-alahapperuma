                ...
                <div class="e-content card mt-3">
                    <div class="card-body">
                        ...
                        <ol class="mb-0">
                            ...
                            <li id="reference-2">This website will serve images on certain pages, such as the portfolio page (If I ever create one), certain articles (Whenever diagrams are necessary), and so on. However, I prefer to adhere to the principle of minimalism. Therefore, there will be images, but only a few.</li>
                        </ol>
                    </div>
                </div>
                <x-includes.footer />
