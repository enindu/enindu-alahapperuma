...
<x-layouts.base :description="$description" :id="$id" :keywords="$keywords" :title="$title" :type="$type">
    <x-slot:meta>
        ...
        <meta content="{{ \Carbon\Carbon::parse('2024-01-09 at 07:42 PM')->toIso8601String() }}" property="article:modified_time">
        <meta content="{{ \Carbon\Carbon::parse('2024-01-09 at 07:42 PM')->add('1 year')->toIso8601String() }}" property="article:expiration_time">
                ...
                <div class="e-content card mt-3">
                    <div class="card-body">
                        ...
                        <ul>
                            ...
                            <li><strong>Front-end libraries:</strong> <a href="https://vitejs.dev" target="_blank">Vite</a>, <a href="https://fonts.google.com" target="_blank">Google Fonts</a>, <a href="https://fontawesome.com" target="_blank">Font Awesome</a></li>
                        ...
                        <ol class="mb-0">
                            <li id="reference-1">I had to move to an EC2 server because the company's testing server had expired.</li>
                            <li id="reference-2">I have changed the theme color. This time, I chose <a href="https://tailwindcss.com/docs/customizing-colors" target="_blank">Tailwind colors</a> instead of Halfmoon colors. So, this will be my branding.</li>
                            <li id="reference-3">This website will serve images on certain pages, such as the portfolio page (If I ever create one), certain articles (Whenever diagrams are necessary), and so on. However, I prefer to adhere to the principle of minimalism. Therefore, there will be images, but only a few.</li>
                        </ol>
                    </div>
                </div>
                <x-includes.footer />
