...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="x-content">
                <h1>How Poor Development Skills Break Internet</h1>
