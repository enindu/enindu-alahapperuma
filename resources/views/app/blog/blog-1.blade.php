...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="x-content">
                <h1>I Have Revamped My Website</h1>
    ...
    <div class="card">
        <div class="card-body">
            <div class="x-content">
                <p>This is the fourth version of my website. In the early days, I used a custom-built static site generator written in Go to generate plain HTML pages, which were then hosted on a basic shared server. At that time, I was not offering freelance services and had no plans to write articles—the website simply served as a personal introduction. You can view the second version of my site on the Wayback Machine by clicking <a href="https://web.archive.org/web/20220108080945/https://enindu.com" target="_blank">this link</a>. Unfortunately, there is no archived capture of the first version. With the third version, I discontinued my static site generator and migrated the website to the Laravel framework for better flexibility and scalability. You can see the third version <a href="https://web.archive.org/web/20240215133408/https://enindu.com" target="_blank">here</a>. Several factors influenced my decision to move away from the static site generator.</p>
                <ul>
