...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <div class="x-content">
                <p>First off, assuming you're familiar with the OSI model, DNS operates as an application-layer protocol. It allows systems to translate domain names into IP addresses, eliminating the need to memorize IP addresses manually. As a critical component of web infrastructure, DNS is something every web developer should understand, along with fundamental HTTP concepts. While it's not mandatory for the average web developer, having a solid grasp of how DNS works can be highly beneficial. Here's a simplified explanation of its operation.</p>
                <p>First, it's important to understand that there are four types of DNS servers. I won't go into detail about each one here, but you'll get a basic understanding of them as we progress through this article.</p>
                <ul>
                ...
                <p>The main difference is that the DNS response includes an additional field called "answer data". Here's the structure of a DNS response.</p>
                <ul>
                    <li>Transaction ID</li>
                    <li>Flags</li>
                    <li>Questions</li>
                ...
                <p>I'm not going to explain every field in this structure in detail, but there is something worth mentioning. In DNS requests, the "Answer RRs", "Authority RRs", and "Additional RRs" fields are always null because they store information about DNS records. These fields get populated when DNS responses are sent.</p>
                <p>Now that you're familiar with the DNS message structure, I won't go into DNS records in detail since most web developers are already familiar with them. Instead, let's focus on the structure of a DNS record.</p>
                <ul>
