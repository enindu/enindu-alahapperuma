...
writer.WriteString(string([]byte{0xF0, 0x9D, 0x92, 0x9C}) + "\n")</code></pre>
                ...
                <p class="mb-0">This article has already become quite long, so I will continue discussing the lowest-level HTTP server in a separate article. You can find the code I used for this demonstration at <a href="https://github.com/enindu/examples-for-blog/tree/master/playing-with-http-servers-and-go" target="_blank">https://github.com/enindu/examples-for-blog/tree/master/playing-with-http-servers-and-go</a>.</p>
            </div>
        </div>
    </div>
@endsection
